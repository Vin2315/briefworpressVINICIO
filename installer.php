...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Vinicio123_8d2269436b3bce2e9713_20211014140825_archive.zip';
	const ARCHIVE_SIZE		 = '36099950';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8d22694-14140825';
    const SECONDARY_PACKAGE_HASH = 'e070039-14140825';
	const VERSION			 = '1.4.3';
